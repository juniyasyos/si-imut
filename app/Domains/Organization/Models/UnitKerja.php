 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Domains\Imut\Models\ImutData[] $imutData
 * @property-read Folder|null $folder
 * @property-read \App\Domains\Reporting\Models\LaporanImut|null $laporanImut
 */
class UnitKerja extends Model
{
    ...
    {
        return $this->hasMany(\App\Domains\Reporting\Models\LaporanUnitKerja::class, 'unit_kerja_id');
    }
