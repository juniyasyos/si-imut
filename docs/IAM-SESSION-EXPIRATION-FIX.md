...
- **Client Plugin Middleware**: `laravel-iam-client/src/Http/Middleware/VerifyIamToken.php`
- **Token Validator**: `laravel-iam-client/src/Support/TokenValidator.php`
- **Session Config**: `config/session.php`
- **IAM Config**: `config/iam.php`
- **IAM Client Documentation**: `laravel-iam-client/README.md`
