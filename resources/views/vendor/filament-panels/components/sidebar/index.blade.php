    ...
    <div class="overflow-x-clip">
        <header
            ...
            @if (filament()->isSidebarCollapsibleOnDesktop())
                <x-filament::icon-button color="gray" :icon="$isRtl ? 'heroicon-o-bars-3-bottom-right' : 'heroicon-o-bars-3-bottom-left'"
                    :icon-alias="['panels::sidebar.expand-button.rtl', 'panels::sidebar.expand-button']"
            ...
            @if (filament()->isSidebarCollapsibleOnDesktop() || filament()->isSidebarFullyCollapsibleOnDesktop())
                <x-filament::icon-button color="gray" :icon="$isRtl ? 'heroicon-o-bars-3-bottom-left' : 'heroicon-o-bars-3-bottom-right'"
                    :icon-alias="['panels::sidebar.collapse-button.rtl', 'panels::sidebar.collapse-button']"
