    ...
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="flex-1">
            <div class="relative">
                ...
                <input x-model="searchQuery" type="text" placeholder="Cari indikator..."
        ...
        <div class="flex flex-wrap gap-2">
            <button @click="statusFilter = 'all'" :class="statusFilter === 'all'
            ...
            <button @click="statusFilter = 'pending'" :class="statusFilter === 'pending'
            ...
            <button @click="statusFilter = 'done'" :class="statusFilter === 'done'
