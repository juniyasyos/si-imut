    ...
    <div class="flex flex-col lg:flex-row gap-4">
        ...
        <div class="flex-1">
            <div class="relative">
                ...
                <input wire:model.live="searchQuery" type="text" placeholder="Cari indikator..."
        ...
        <div class="flex flex-wrap gap-2">
            <button wire:click="$set('statusFilter', 'all')" :class="$wire.statusFilter === 'all'
            ...
            <button wire:click="$set('statusFilter', 'pending')" :class="$wire.statusFilter === 'pending'
            ...
            <button wire:click="$set('statusFilter', 'done')" :class="$wire.statusFilter === 'done'
