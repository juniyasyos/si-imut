                ...
                <div class="flex-1 overflow-y-auto px-6 py-6 bg-gray-50 dark:bg-slate-800">
                    ...
                    <div class="mb-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div wire:key="daily-report-{{ $report['id'] }}" class="rounded-lg border bg-white dark:bg-slate-800 border-gray-200 dark:border-slate-600 hover:shadow-md transition-shadow
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="flex items-center gap-2 pt-3 border-t border-gray-200 dark:border-slate-600">
                                        ...
                                        <button type="button"
                                            ...
                                            <span class="flex-1 inline-flex items-center justify-center" wire:loading.remove wire:target="deleteReport({{ $report['id'] }})">
                                                @svg("heroicon-m-trash", "w-4 h-4 mr-1.5")
                                                Hapus
                                            </span>
                                            <span wire:loading wire:target="deleteReport({{ $report['id'] }})" class="flex-1 inline-flex items-center justify-center inline-flex items-center gap-1.5">
                                                <svg class="animate-spin w-4 h-4" fill="none" viewBox="0 0 24 24">
                                                    <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
                                                    <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8v8z" />
                                                </svg>
