    ...
    <x-filament::section>
                ...
                <div class="grid grid-cols-2 gap-2">
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <x-heroicon-o-users class="w-8 h-8 text-gray-400 dark:text-gray-600" />
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <x-heroicon-o-clipboard-document-list class="w-8 h-8 text-gray-400 dark:text-gray-600" />
                        </div>
                    </div>
                </div>
                    ...
                    <div class="space-y-2">
                        ...
                        @empty
                            <div
                                ...
                                <x-heroicon-o-user-group class="w-12 h-12 mx-auto text-gray-400 dark:text-gray-600" />
        ...
        @else
            <div class="px-4 py-12 text-center">
                <x-heroicon-o-building-office-2 class="w-16 h-16 mx-auto text-gray-400 dark:text-gray-600" />
