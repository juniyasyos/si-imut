...
<x-filament-widgets::widget>
    <x-filament::section class="pt-6 pb-4 dark:bg-slate-900">
        ...
        @if (!$hasReports && !$showPrevious)
            {{-- Empty State --}}
            <div
                class="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 py-12 text-center dark:border-slate-700">
                            ...
                            @if ($stats && $stats['total_units'] > 0)
                                        <div class="mt-3 space-y-2">
                                            <div class="flex items-center justify-between text-xs">
                                                ...
                                                <span
                                                    class="font-semibold text-gray-900 dark:text-gray-50">{{ $stats['completed_units'] }}/{{ $stats['total_units'] }}
                                                    ...
                                                    @if ($this->isDetailExpanded($previousReport['id']))
                                                        <div class="space-y-2 rounded-lg bg-white/30 p-3 dark:bg-slate-700">
                                                            @foreach ($stats['unit_details'] as $detail)
                                                                <div
                                                                    class="rounded-lg border border-gray-200 bg-white/80 p-3 text-xs dark:border-slate-700 dark:bg-slate-800">
                                                                    ...
                                                                    <div class="flex items-start justify-between gap-2 mb-2">
                                                                        <div class="flex-1">
                                                                            <p class="font-semibold text-gray-900 dark:text-gray-50">
                                                                                {{ $detail['unit_name'] }}</p>
                                                                            <p
                                                                                class="text-xs {{ $detail['is_completed'] ? 'text-green-600 dark:text-green-400' : 'text-gray-600 dark:text-gray-400' }} font-medium mt-0.5">
                                                                                {{ $detail['status_text'] }}
                                                                            </p>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="mb-2">
                                                                        <div class="flex items-center justify-between text-xs mb-1">
                                                                            ...
                                                                            <span
                                                                                class="font-semibold text-gray-900 dark:text-gray-50">{{ $detail['completed'] }}/{{ $detail['total'] }}
                                                                                ({{ $detail['percentage'] }}%)</span>
                                                                        </div>
                                                                        <div
                                                                            class="h-1.5 w-full overflow-hidden rounded-full bg-gray-200 dark:bg-slate-700/50">
                                                                    ...
                                                                    <div class="space-y-0.5 border-t border-gray-200 pt-1.5 dark:border-slate-700">
                                                                        <div class="flex justify-between">
                                                                            ...
                                                                            <span
                                                                                class="font-medium text-gray-900 dark:text-gray-50">{{ $detail['period_end']->format('d M Y') }}</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endforeach
                ...
                <div class="mb-6 rounded-lg border-2 {{ $config['border'] }} {{ $config['bg'] }} p-5">
                    <div class="flex items-start justify-between gap-4">
                        <div class="flex items-start gap-3 flex-1">
                            <div
                                class="mt-1 rounded-lg {{ str_replace('bg-', 'bg-', $config['badge']) }} p-2 dark:bg-slate-800/50">
                            ...
                            <div class="flex-1">
                                ...
                                <div
                                    class="mb-4 rounded-lg {{ $config['bg'] }} border-2 {{ $config['border'] }} p-4 dark:bg-slate-800/30 dark:border-slate-700">
                                    <div class="grid grid-cols-2 gap-4">
                                        {{-- Deadline Date --}}
                                        <div>
                                            <p class="text-xs font-semibold uppercase {{ $config['text'] }} mb-1">Deadline
                                                Pengisian</p>
                                        ...
                                        <div class="flex flex-col items-end justify-center">
                                            @if ($mostUrgent['is_overdue'])
                                                <p class="text-sm font-bold text-red-600 dark:text-red-400 mb-1">TERLEWAT DEADLINE!
                                                </p>
                                            ...
                                            @else
                                                ...
                                                @if ($mostUrgent['days_remaining'] < 1)
                                                    <p class="text-xs {{ $config['text'] }} mt-2 text-center font-bold">HARI TERAKHIR!
                                                    </p>
                                                @else
                                ...
                                @if ($stats && $stats['total_units'] > 0)
                                                <div class="mt-3 space-y-2">
                                                    <div class="flex items-center justify-between text-xs">
                                                        <span class="text-gray-600 dark:text-gray-400">Progres Pengisian Analisis Semua
                                                            Unit</span>
                                                        <span
                                                            class="font-semibold text-gray-900 dark:text-gray-50">{{ $stats['completed_units'] }}/{{ $stats['total_units'] }}
                                                            ({{ $stats['percentage'] }}%)</span>
                                                    ...
                                                    <div class="mt-4 space-y-2">
                                                        ...
                                                        @if ($this->isDetailExpanded($mostUrgent['id']))
                                                            <div class="space-y-2 rounded-lg bg-gray-50 p-3 dark:bg-slate-700">
                                                                @foreach ($stats['unit_details'] as $detail)
                                                                    <div
                                                                        class="rounded-lg border border-gray-200 bg-white p-3 text-xs dark:border-slate-800 dark:bg-slate-700">
                                                                        {{-- Header: Unit Name + Status --}}
                                                                        <div class="flex items-start justify-between gap-2 mb-2">
                                                                            <div class="flex-1">
                                                                                <p class="font-semibold text-gray-900 dark:text-gray-50">
                                                                                    {{ $detail['unit_name'] }}</p>
                                                                                <p
                                                                                    class="text-xs {{ $detail['is_completed'] ? 'text-green-600 dark:text-green-400' : ($detail['is_overdue'] ? 'text-red-600 dark:text-red-400' : 'text-gray-600 dark:text-gray-400') }} font-medium mt-0.5">
                                                                                    {{ $detail['status_text'] }}
                                                                                </p>
                                                                            </div>
                                                                            @if (!$detail['is_overdue'] && !$detail['is_completed'])
                                                                                <span
                                                                                    class="inline-flex items-center gap-1 rounded-full bg-blue-100 px-2 py-1 font-semibold text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 flex-shrink-0">
                                                                        ...
                                                                        <div class="space-y-0.5 border-t border-gray-200 pt-2 dark:border-slate-700">
                                                                            <div class="flex justify-between items-center">
                                                                                <span class="text-gray-600 dark:text-gray-400 font-semibold">📅
                                                                                    Deadline:</span>
                                                                                <span
                                                                                    class="font-bold {{ $detail['is_overdue'] ? 'text-red-600 dark:text-red-400' : 'text-blue-600 dark:text-blue-300' }}">
                                                                            ...
                                                                            @if (!$detail['is_completed'])
                                                                                <div class="flex justify-between items-center">
                                                                                    ...
                                                                                    <span
                                                                                        class="font-bold {{ $detail['is_overdue'] ? 'text-red-600 dark:text-red-400' : 'text-green-600 dark:text-green-400' }}">
                                                                            ...
                                                                            <div class="flex justify-between text-xs">
                                                                                ...
                                                                                <span
                                                                                    class="text-gray-700 dark:text-gray-300">{{ $detail['period_end']->format('d M Y') }}</span>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                @endforeach
            ...
            @if (count($reports) > 1)
                <div class="space-y-3">
                    ...
                    @foreach (array_slice($reports, 1) as $report)
                        ...
                        @endphp
                        <div
                            class="flex flex-col gap-3 rounded-lg border {{ $config['border'] }} {{ $config['bg'] }} px-4 py-3 transition hover:shadow-sm">
                            <div class="flex items-center gap-4">
                                <div class="flex flex-1 items-center gap-3">
                                    <div
                                        class="rounded-lg {{ str_replace('bg-', 'bg-', $config['badge']) }} p-2 dark:bg-slate-800/50">
                            ...
                            @if ($stats && $stats['total_units'] > 0)
                                <div class="space-y-2 border-t {{ $config['border'] }} pt-3 dark:border-slate-700">
                                    <div class="flex items-center justify-between text-xs">
                                        <span class="text-gray-600 dark:text-gray-400">Pengisian:
                                            {{ $stats['completed_units'] }}/{{ $stats['total_units'] }} unit kerja</span>
                                    ...
                                    @if (!empty($stats['unit_details']))
                                        ...
                                        @if ($this->isDetailExpanded($report['id']))
                                            <div class="space-y-2 rounded-lg bg-gray-50/50 p-2.5 dark:bg-slate-800/20">
                                                @foreach ($stats['unit_details'] as $detail)
                                                    <div
                                                        class="rounded-lg border border-gray-200 bg-white p-2.5 text-xs dark:border-slate-700 dark:bg-slate-800/40">
                                                        {{-- Header: Unit Name + Status --}}
                                                        <div class="flex items-start justify-between gap-2 mb-1.5">
                                                            ...
                                                            @if (!$detail['is_overdue'] && !$detail['is_completed'] && $detail['total'] > 0)
                                                                <span
                                                                    class="inline-flex items-center gap-0.5 rounded-full bg-blue-100 px-1.5 py-0.5 font-semibold text-blue-700 dark:bg-blue-900/30 dark:text-blue-300 flex-shrink-0 whitespace-nowrap text-xs">
                                                        ...
                                                        @if ($detail['total'] > 0)
                                                            <div class="mb-1.5">
                                                                <div class="flex items-center justify-between text-xs mb-0.5">
                                                                    <span
                                                                        class="text-gray-600 dark:text-gray-400">{{ $detail['completed'] }}/{{ $detail['total'] }}</span>
                                                                    <span
                                                                        class="font-semibold text-gray-900 dark:text-gray-50">{{ $detail['percentage'] }}%</span>
                                                                </div>
                                                        ...
                                                        @else
                                                            <p class="text-xs text-gray-500 dark:text-gray-400 italic mb-1.5">Tidak ada data penilaian
                                                            </p>
                                                        @endif
                                                        ...
                                                        <div class="space-y-0.5 border-t border-gray-200 pt-1.5 dark:border-slate-700 text-xs">
                                                            <div class="flex justify-between">
                                                                ...
                                                                <span
                                                                    class="font-medium {{ $detail['is_overdue'] ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-gray-50' }}">{{ $detail['analysis_deadline']->format('d M Y') }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                @endforeach
