    ...
    <div class="lg:hidden fixed bottom-0 left-0 right-0 z-40 bg-white dark:bg-slate-800 border-t border-gray-200 dark:border-slate-700 shadow-lg backdrop-blur-lg bg-white/95 dark:bg-slate-800/95">
        <div class="px-4 py-3 safe-bottom">
            <div class="flex items-center gap-3">
                ...
                <a href="{{ $this->getResource()::getUrl('index') }}"
                    class="inline-flex items-center justify-center gap-2 px-4 py-3 text-gray-700 dark:text-gray-300 bg-gray-100 dark:bg-slate-700 hover:bg-gray-200 dark:hover:bg-slate-600 font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-gray-500 dark:focus:ring-gray-400">
