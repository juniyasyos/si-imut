    ...
    <div class="max-w-6xl mx-auto bg-white p-8 shadow-xl border border-gray-200" style="min-height: calc(100vh - 100px);">
        ...
        <div class="report-header border-b-2 border-gray-800 pb-4 mb-8">
            <div class="flex items-start justify-between gap-6 mb-3">
                <!-- Logo Kiri -->
                 <div class="w-16 h-16 flex-shrink-0">
                    <img src="../public/images/assets/logo-rs.webp"
                ...
                <div class="flex-1 text-center">
                    ...
                    <h2 class="text-base font-bold text-gray-800 uppercase" style="letter-spacing: 1.5px;">Laporan Triwulan Indikator Mutu</h2>
            ...
            <div class="bg-gray-100 border border-gray-300 rounded px-4 py-2 flex justify-between items-center text-xs">
                <div><span class="font-semibold text-gray-700">Nomor Dokumen:</span> <span class="text-gray-600">IMUT/LAP/001/2024</span></div>
                <div><span class="font-semibold text-gray-700">Tanggal Cetak:</span> <span class="text-gray-600">{{ now()->format('d/m/Y') }}</span></div>
                <div><span class="font-semibold text-gray-700">Halaman:</span> <span class="text-gray-600">1 dari 1</span></div>
            </div>
        </div>
